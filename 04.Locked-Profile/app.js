function showMore(e) {
    ...
    showMoreButton.textContent = showMoreButton.textContent == 'Hide it' ? 'Show More'
        : 'Hide it';
...
/*********************** A second solution by using material from routing lecture.****************************/
...
//         <input type="text" name="user1Username" value=${profile.username} />
//         <div id="user1HiddenFields">
//             <hr>
//             <label>Email:</label>
//             <input type="email" name="user1Email" value=${profile.email} />
//             <label>Age:</label>
//             <input type="email" name="user1Age" value=${profile.age} />
//         </div>
//         <button @click=${showMore}>Show more</button>
//     </div>`;

//     const main = document.getElementById('main');
//     render(Object.values(data).map(template), main)
// }